...
public class ZavierEventHandler implements IWorldGenerator {
	...
	private void generateSurface(World world, Random random, int x, int z) {
		addOreSpawn(ZavierMod.rubyore, 0, Blocks.stone, world, random, x, z, 16, 16, 20, 4, 1, 120);
	...
	/**
	 * Adds an Ore Spawn to Minecraft. Just register all your ores to spawn in this Class
	 * 
